...
from app.plugins.sitestatisticself.siteuserinfo import ISiteUserInfo
...
class SiteStatisticSelf(_PluginBase):
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "sitestatisticself_"
    # 加载顺序
    plugin_order = 1
    # 可使用的用户级别
    auth_level = 1
    ...
    def init_plugin(self, config: dict = None):
        ...
        if self._enabled or self._onlyonce:
            # 加载模块
            self._site_schema = ModuleHelper.load('app.plugins.sitestatisticself.siteuserinfo',
